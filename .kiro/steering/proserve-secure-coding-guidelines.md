...
[https://w.amazon.com/bin/view/AWS/Teams/Proserve/SRC/EngagementSecurity/SecureCodingGuidelines]

When generating project documentation or code you should follow the rules to generate code that complies with AWS ProServe Secure Coding Guidelines:
...
These rules should be implemented as validation checks in the LLM's code generation process to ensure compliance with AWS ProServe security standards.